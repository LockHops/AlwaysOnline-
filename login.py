...
if client.is_user_authorized() is not True:
    ...
    logging.info(
        'if you have 2FA password, please input right now. This Password will not be stored. Otherwise, please press the Enter Key | 如果你有两步验证密码，请现在输入。这个密码不会被保存。否则请直接输入回车')
